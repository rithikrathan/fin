              ...
              {recentTx.map((tx) => (
                <div key={tx.id} className="flex items-center justify-between">
                  <div className="flex items-center gap-4 min-w-0">
                    <div
                      className={`h-10 w-10 rounded-xl flex items-center justify-center text-sm shrink-0 ${
                        tx.type === 'income'
                  ...
                  {state.investments.map((inv) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span
                          className={`font-mono text-base font-semibold shrink-0 ml-3 ${
                            roi >= 0 ? 'text-gain' : 'text-loss'
                          }`}
                        >
                          {roi >= 0 ? '+' : ''}
                          {roi.toFixed(1)}%
