    ...
    return (
        <div className="flex h-screen bg-base overflow-hidden select-none">
            ...
            <div className="flex flex-col flex-1 min-w-0">
                ...
                {!moreOpen && (
                    <nav id="bottom-nav" className="lg:hidden sticky bottom-0 left-0 right-0 z-40 bg-surface/95 backdrop-blur-xl border-t border-border-subtle flex items-center justify-around py-1.5 pb-[calc(8px+env(safe-area-inset-bottom,8px))] px-2">
                        {bottomLinks.map((link) => {
                            ...
                            return (
                                ...
                                >
                                    {({ isActive }) => (
                                        <>
                                            <div className={`px-4 py-1 rounded-full transition-all duration-300 flex items-center justify-center ${isActive ? 'bg-brand/15 text-brand' : 'bg-transparent text-txt-secondary'}`}>
                        ...
                        {(() => {
                            ...
                            return (
                                <button
                                    ...
                                    className="flex flex-col items-center justify-center transition-all duration-200 min-w-[64px] min-h-[52px] py-1 cursor-pointer active:scale-90"
                                >
                                    <div className={`px-4 py-1 rounded-full transition-all duration-300 flex items-center justify-center ${isMoreActive ? 'bg-brand/15 text-brand' : 'bg-transparent text-txt-secondary'}`}>
